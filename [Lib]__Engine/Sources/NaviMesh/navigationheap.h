...
public:
	...
	// ----- MUTATORS ---------------------
	void Setup(int SessionID, const D3DXVECTOR3& Goal);
...
//
//-------------------------------------------------------------------------------------://
inline void NavigationHeap::Setup(int SessionID, const D3DXVECTOR3& Goal)
{
	m_Goal = Goal;
...
inline 	const D3DXVECTOR3& NavigationHeap::Goal()const
{
	return(m_Goal);
}
