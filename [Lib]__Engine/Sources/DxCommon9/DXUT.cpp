...
protected:
    struct STATE
    {
        ...
        D3DCAPSQ             m_Caps;                    // D3D caps for current device
...
public:
    ...
    void Create()
    {
        ...
        SecureZeroMemory( &m_state, sizeof(STATE) ); 
        g_bThreadSafe = true; 
    ...
    GETP_SETP_ACCESSOR( D3DCAPSQ, Caps );
...
HRESULT DXUTInit( bool bParseCommandLine, bool bHandleDefaultHotkeys, bool bShowMsgBoxOnError )
{
    ...
    {
        StringCchCatW( wszPath, MAX_PATH, L"\\winmm.dll" );
        HINSTANCE hInstWinMM = LoadLibraryW( wszPath );
        if( hInstWinMM ) 
        {
...
void DXUTParseCommandLine()
{
    WCHAR* strCmdLine = GetCommandLineW();
    ...
    for(;;)
    {
        ...
        StringCchCopyW( strFlag, 256, L"adapter" ); nFlagLen = (int) wcslen(strFlag);
        ...
        StringCchCopyW( strFlag, 256, L"windowed" ); nFlagLen = (int) wcslen(strFlag);
        if( _wcsnicmp( strCmdLine, strFlag, nFlagLen ) == 0 )
        {
        ...
        StringCchCopyW( strFlag, 256, L"fullscreen" ); nFlagLen = (int) wcslen(strFlag);
        if( _wcsnicmp( strCmdLine, strFlag, nFlagLen ) == 0 )
        {
        ...
        StringCchCopyW( strFlag, 256, L"forcehal" ); nFlagLen = (int) wcslen(strFlag);
        if( _wcsnicmp( strCmdLine, strFlag, nFlagLen ) == 0 )
        {
        ...
        StringCchCopyW( strFlag, 256, L"forceref" ); nFlagLen = (int) wcslen(strFlag);
        if( _wcsnicmp( strCmdLine, strFlag, nFlagLen ) == 0 )
        {
        ...
        StringCchCopyW( strFlag, 256, L"forcepurehwvp" ); nFlagLen = (int) wcslen(strFlag);
        if( _wcsnicmp( strCmdLine, strFlag, nFlagLen ) == 0 )
        {
        ...
        StringCchCopyW( strFlag, 256, L"forcehwvp" ); nFlagLen = (int) wcslen(strFlag);
        if( _wcsnicmp( strCmdLine, strFlag, nFlagLen ) == 0 )
        {
        ...
        StringCchCopyW( strFlag, 256, L"forceswvp" ); nFlagLen = (int) wcslen(strFlag);
        if( _wcsnicmp( strCmdLine, strFlag, nFlagLen ) == 0 )
        {
        ...
        StringCchCopyW( strFlag, 256, L"width" ); nFlagLen = (int) wcslen(strFlag);
        if( _wcsnicmp( strCmdLine, strFlag, nFlagLen ) == 0 )
        {
            if( DXUTGetCmdParam( strCmdLine, strFlag, nFlagLen ) )
            {
        ...
        StringCchCopyW( strFlag, 256, L"height" ); nFlagLen = (int) wcslen(strFlag);
        if( _wcsnicmp( strCmdLine, strFlag, nFlagLen ) == 0 )
        {
            if( DXUTGetCmdParam( strCmdLine, strFlag, nFlagLen ) )
            {
        ...
        StringCchCopyW( strFlag, 256, L"startx" );
        ...
        StringCchCopyW( strFlag, 256, L"starty" );
        nFlagLen = (int) wcslen(strFlag);
        if( _wcsnicmp( strCmdLine, strFlag, nFlagLen ) == 0 )
        {
            if( DXUTGetCmdParam( strCmdLine, strFlag, nFlagLen ) )
        ...
        StringCchCopyW( strFlag, 256, L"constantframetime" ); nFlagLen = (int) wcslen(strFlag);
        if( _wcsnicmp( strCmdLine, strFlag, nFlagLen ) == 0 )
        {
            float fTimePerFrame;
            if( DXUTGetCmdParam( strCmdLine, strFlag, nFlagLen ) )
        ...
        StringCchCopyW( strFlag, 256, L"quitafterframe" ); nFlagLen = (int) wcslen(strFlag);
        if( _wcsnicmp( strCmdLine, strFlag, nFlagLen ) == 0 )
        {
            if( DXUTGetCmdParam( strCmdLine, strFlag, nFlagLen ) )
            {
        ...
        StringCchCopyW( strFlag, 256, L"noerrormsgboxes" ); nFlagLen = (int) wcslen(strFlag);
        if( _wcsnicmp( strCmdLine, strFlag, nFlagLen ) == 0 )
        {
        ...
        StringCchCopyW( strFlag, 256, L"automation" ); nFlagLen = (int) wcslen(strFlag);
        if( _wcsnicmp( strCmdLine, strFlag, nFlagLen ) == 0 )
        {
                          ...
                          HICON hIcon, HMENU hMenu, int x, int y )
{
    ...
    if( DXUTGetHWNDFocus() == NULL )
    {
        ...
        StringCchCopyW( strCachedWindowTitle, 256, strWindowTitle );

        // Create the render window
        HWND hWnd = CreateWindowW( L"Direct3DWindowClass", strWindowTitle, dwWindowStyle,
                          ...
                          void* pUserContext )
{
    ...
    SecureZeroMemory( &deviceSettings, sizeof(DXUTDeviceSettings) );
...
HRESULT DXUTSetDevice( IDirect3DDevice9* pd3dDevice )
{
    ...
    SecureZeroMemory( pDeviceSettings, sizeof(DXUTDeviceSettings) );
                                     ...
                                     DXUTMatchOptions* pMatchOptions )
{
    ...
    {
        SecureZeroMemory( &defaultMatchOptions, sizeof(DXUTMatchOptions) );
                                     ...
                                     DXUTMatchOptions* pMatchOptions )
{
    ...
    SecureZeroMemory( pOptimalDeviceSettings, sizeof(DXUTDeviceSettings) ); 
                                   ...
                                   DXUTMatchOptions* pMatchOptions )
{
    ...
    SecureZeroMemory( pValidDeviceSettings, sizeof(DXUTDeviceSettings) );
...
{
    D3DDISPLAYMODE bestDisplayMode;
    SecureZeroMemory( &bestDisplayMode, sizeof(D3DDISPLAYMODE) );
...
HRESULT DXUTChangeDevice( DXUTDeviceSettings* pNewDeviceSettings, IDirect3DDevice9* pd3dDeviceFromApp, bool bForceRecreate, bool bClipWindowToSingleAdapter )
{
    ...
    else 
    {
        ...
        if( pOldDeviceSettings == NULL || (pOldDeviceSettings && pOldDeviceSettings->pp.Windowed) )
        {
            ...
            SecureZeroMemory( pwp, sizeof(WINDOWPLACEMENT) );
        ...
        SecureZeroMemory( &wpFullscreen, sizeof(WINDOWPLACEMENT) );
    ...
    D3DCAPSQ* pd3dCaps = GetDXUTState().GetCaps();
...
void DXUTUpdateFrameStats()
{
    ...
    if( fTime - fLastTime > 1.0f )
    {
        ...
        StringCchPrintfW( pstrFrameStats, 256, pstrStaticFrameStats, fFPS );
...
void DXUTUpdateStaticFrameStats()
{
    ...
    {
        StringCchCopyW( strFmt, 100, DXUTD3DFormatToString( pDeviceSettingsCombo->AdapterFormat, false ) );
    }
    else
    {
        StringCchPrintfW( strFmt, 100, L"backbuf %s, adapter %s", 
    ...
    {
        StringCchPrintfW( strDepthFmt, 100, L" (%s)", DXUTD3DFormatToString( pPP->AutoDepthStencilFormat, false ) );
    }
    else
    {
        // No depth buffer
    ...
    {
        case D3DMULTISAMPLE_NONMASKABLE: StringCchCopyW( strMultiSample, 100, L" (Nonmaskable Multisample)" ); break;
        case D3DMULTISAMPLE_NONE:        StringCchCopyW( strMultiSample, 100, L"" ); break;
        default:                         StringCchPrintfW( strMultiSample, 100, L" (%dx Multisample)", pPP->MultiSampleType ); break;
    }

    WCHAR* pstrStaticFrameStats = GetDXUTState().GetStaticFrameStats();
    StringCchPrintfW( pstrStaticFrameStats, 256, L"%%.02f fps (%dx%d), %s%s%s", 
...
void DXUTCleanup3DEnvironment( bool bReleaseSettings )
{
    ...
    if( pd3dDevice != NULL )
    {
        ...
        SecureZeroMemory( pbackBufferSurfaceDesc, sizeof(D3DSURFACE_DESC) );

        D3DCAPSQ* pd3dCaps = GetDXUTState().GetCaps();
        SecureZeroMemory( pd3dCaps, sizeof(D3DCAPSQ) );
...
void DXUTUpdateBackBufferDesc()
{
    ...
    SecureZeroMemory( pBBufferSurfaceDesc, sizeof(D3DSURFACE_DESC) );
    if( SUCCEEDED(hr) )
    {
...
const D3DCAPSQ* DXUTGetDeviceCaps()                 { return GetDXUTState().GetCaps(); }
...
{ 
    ...
    else 
    {
        ...
        SecureZeroMemory( &pp, sizeof(D3DPRESENT_PARAMETERS) );
        return pp; 
    }
}
...
{ 
    ...
    else
    {
        ...
        SecureZeroMemory( &ds, sizeof(DXUTDeviceSettings) );
        return ds;
    }
} 
...
void DXUTDisplayErrorMessage( HRESULT hr )
{
    ...
    switch( hr )
    {
        case DXUTERR_NODIRECT3D:             nExitCode = 2; StringCchCopyW( strBuffer, 512, L"Could not initialize Direct3D. You may want to check that the latest version of DirectX is correctly installed on your system.  Also make sure that this program was compiled with header files that match the installed DirectX DLLs." ); break;
        case DXUTERR_INCORRECTVERSION:       nExitCode = 10; StringCchCopyW( strBuffer, 512, L"Incorrect version of Direct3D and/or D3DX." ); break;
        case DXUTERR_MEDIANOTFOUND:          nExitCode = 4; StringCchCopyW( strBuffer, 512, L"Could not find required media. Ensure that the DirectX SDK is correctly installed." ); break;
        case DXUTERR_NONZEROREFCOUNT:        nExitCode = 5; StringCchCopyW( strBuffer, 512, L"The D3D device has a non-zero reference count, meaning some objects were not released." ); break;
        case DXUTERR_CREATINGDEVICE:         nExitCode = 6; StringCchCopyW( strBuffer, 512, L"Failed creating the Direct3D device." ); break;
        case DXUTERR_RESETTINGDEVICE:        nExitCode = 7; StringCchCopyW( strBuffer, 512, L"Failed resetting the Direct3D device." ); break;
        case DXUTERR_CREATINGDEVICEOBJECTS:  nExitCode = 8; StringCchCopyW( strBuffer, 512, L"Failed creating Direct3D device objects." ); break;
        case DXUTERR_RESETTINGDEVICEOBJECTS: nExitCode = 9; StringCchCopyW( strBuffer, 512, L"Failed resetting Direct3D device objects." ); break;
        case DXUTERR_NOCOMPATIBLEDEVICES:    
            nExitCode = 3; 
            if( GetSystemMetrics(SM_REMOTESESSION) != 0 )
                StringCchCopyW( strBuffer, 512, L"Direct3D does not work over a remote session." ); 
            else
                StringCchCopyW( strBuffer, 512, L"Could not find any compatible Direct3D devices." ); 
            break;
    ...
    if( bFound && bShowMsgBoxOnError )
    {
        if( DXUTGetWindowTitle()[0] == 0 )
            MessageBoxW( DXUTGetHWND(), strBuffer, L"DirectX Application", MB_ICONERROR|MB_OK );
        else
            MessageBoxW( DXUTGetHWND(), strBuffer, DXUTGetWindowTitle(), MB_ICONERROR|MB_OK );
    }
}
                          ...
                          const WCHAR* strMsg, bool bPopMsgBox )
{
    ...
    return DXTraceW( strFile, dwLine, hr, strMsg, bPopMsgBox );
}
...
//--------------------------------------------------------------------------------------
// Initialize the HW cursor and clipped 
//--------------------------------------------------------------------------------------
void DXUTInitHWCursor()
{
