...
public:
    ...
    HRESULT SetVertexDecl( LPDIRECT3DDEVICEQ pd3dDevice, const D3DVERTEXELEMENT9 *pDecl );
    ...
    HRESULT Create( LPDIRECT3DDEVICEQ pd3dDevice, LPCWSTR strFilename );
    HRESULT Create( LPDIRECT3DDEVICEQ pd3dDevice, LPD3DXFILEDATA pFileData );
...
{
    HRESULT LoadMesh( LPDIRECT3DDEVICEQ pd3dDevice, LPD3DXFILEDATA pFileData, 
                      CDXUTMeshFrame* pParentFrame );
    HRESULT LoadFrame( LPDIRECT3DDEVICEQ pd3dDevice, LPD3DXFILEDATA pFileData, 
                       CDXUTMeshFrame* pParentFrame );
public:
    HRESULT Create( LPDIRECT3DDEVICEQ pd3dDevice, LPCWSTR strFilename );
    HRESULT CreateFromResource( LPDIRECT3DDEVICEQ pd3dDevice, LPCWSTR strResource, LPCWSTR strType );
