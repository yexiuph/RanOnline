...
public:
    ...
    void SetCaptionText( const wchar_t *pwszText ) { StringCchCopyW( m_wszCaption, sizeof(m_wszCaption)/sizeof(m_wszCaption[0]), pwszText); }
...
public:
    ...
    HRESULT     OnCreateDevice( LPDIRECT3DDEVICEQ pd3dDevice );
