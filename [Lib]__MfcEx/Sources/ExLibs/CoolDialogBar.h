...
public:
    ...
    virtual BOOL Create(CWnd* pParentWnd, CDialog* pDialog, CString& pTitle, UINT nID, DWORD dwStyle = WS_CHILD | WS_VISIBLE | CBRS_LEFT, CCreateContext* pContext = (CCreateContext*)0 );
...
protected:
   //{{AFX_MSG(CCoolDialogBar)
	...
	afx_msg LRESULT OnNcHitTest(CPoint point); //afx_msg UINT OnNcHitTest(CPoint point);
