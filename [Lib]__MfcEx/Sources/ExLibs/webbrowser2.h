...
public:
	...
	afx_msg void OnDocumentComplete(LPDISPATCH pDisp, VARIANT FAR* URL);//이벤트 받을 함수	
	
public:
	bool IsCompleteLoad() { return m_bIsLoad; }
	void SetCompleteLoad( bool bLoad ) { m_bIsLoad = bLoad; }
};
