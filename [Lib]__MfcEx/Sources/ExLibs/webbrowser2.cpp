...
BEGIN_EVENTSINK_MAP(CWebBrowser2, CWnd)
    //{{AFX_EVENTSINK_MAP(CTestWebDlg)
	 ON_EVENT(CWebBrowser2, (INT)AFX_IDW_PANE_FIRST + 1, 259 /* DocumentComplete */, OnDocumentComplete, VTS_DISPATCH VTS_PVARIANT)
    //}}AFX_EVENTSINK_MAP
END_EVENTSINK_MAP()
...
void CWebBrowser2::OnDocumentComplete(LPDISPATCH pDisp, VARIANT FAR* URL) 
{
	m_bIsLoad = true;
	::SetFocus( NULL );
}
