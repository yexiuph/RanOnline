...
BOOL CCoolDialogBar::Create(CWnd* pParentWnd, CDialog *pDialog, CString &pTitle, UINT nID, DWORD dwStyle, CCreateContext* pContext) 
{
    ...
    CControlBar::DestroyWindow();

    BOOL bReturn = CControlBar::Create(wndclass, pTitle, dwStyle, CRect(0, 0, 0, 0), pParentWnd, nID, pContext);

    if (!CControlBar::Create(wndclass, pTitle, dwStyle, CRect(0, 0, 0, 0), pParentWnd, nID, pContext))
        return FALSE;
