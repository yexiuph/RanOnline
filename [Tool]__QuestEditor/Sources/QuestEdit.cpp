// QuestEdit.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CQuestEditApp, CWinApp)
...
// 유일한 CQuestEditApp 개체입니다.

CQuestEditApp theApp;


// CQuestEditApp 초기화

BOOL CQuestEditApp::InitInstance()
{
